            ...
            for (const result of batchResults) {
                ...
                let tr = `
                    <tr class="${ rowClass } hover:bg-blue-50 dark:hover:bg-blue-900/20 transition-colors duration-150" data-row-id="${ actualIndex }" data-row-index="${ processedData.length - 1 }">
                        ...
                        <td class="border border-gray-200 dark:border-gray-700 px-4 py-2 text-right text-gray-800 dark:text-gray-200 total-expense" id="totalExpense-${ actualIndex }">0</td>
