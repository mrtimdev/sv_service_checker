...
@Entity
@Table(name = "company_small_trucks")
@Audited
@EntityListeners(AuditListener.class)
public class CompanySmallTruck {
    ...
    @Column(name = "litre_quantity", nullable = true)
    private Double litreQuantity;

    @Column(name = "total_oils_change", nullable = true)
    private Double totalOilsChange;

    @Column(columnDefinition = "TEXT", name = "other_oils", nullable = true)
    ...
    private String formatLitre(Number value) {
        return String.format("%,.0f L", value == null ? 0 : value.doubleValue());
    }

    @Transient
    public String getLitreQuantityFormat() {
        return formatLitre(litreQuantity);
    }
