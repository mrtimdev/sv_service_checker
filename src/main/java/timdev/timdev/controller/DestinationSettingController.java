...
public class DestinationSettingController {
    ...
    // Sort.Direction direction = "asc".equalsIgnoreCase(order) ? Sort.Direction.ASC
    // : Sort.Direction.DESC;
    ...
    // Page<DestinationSetting> withPage = service.getAllWithPageable(search,
    // pageable, sort);
    ...
    @ResponseBody
    public ResponseEntity<?> exportSelected(@RequestParam("selectedIds") String selectedIds,
            HttpServletResponse response) {
        try {
            ...
            for (DestinationSetting destination : destinations) {
                ...
                row.createCell(5)
                        .setCellValue(destination.getCreatedAt() != null ? destination.getCreatedAt().toString() : "");
            }
    ...
    public String create(Model model, RedirectAttributes redirectAttributes) {
        if (!permissionChecker.has("DESTINATION_SETTINGS_CREATE")) {
            redirectAttributes.addFlashAttribute("error",
                    "Oop!, You do not have permission to create a new destinations setting.");
    ...
    public String edit(@PathVariable Long id, Model model, RedirectAttributes redirectAttributes) {
        ...
        // redirectAttributes.addFlashAttribute("error", "Destination Setting " +
        // setting.getCode() +" and " + setting.getName() +" can not editable .!");
        // return "redirect:/destination-settings";
        // }
    ...
    public String delete(@PathVariable("id") Long id, RedirectAttributes redirectAttributes) {
        ...
        DestinationSetting setting = service.findById(id);
        if (setting != null && !setting.getDestinationScaleStations().isEmpty()) {
            redirectAttributes.addFlashAttribute("error",
                    "Destination Setting " + setting.getCode() + " and " + setting.getName() + " can not deletable .!");
            return "redirect:/destination-settings";
        } else {
            service.deleteById(id);
            redirectAttributes.addFlashAttribute("success", "Destination Setting " + setting.getCode() + " and "
                    + setting.getName() + " successfully deleted.!");
        }
